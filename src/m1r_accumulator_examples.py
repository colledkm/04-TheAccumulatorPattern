...
#
#           I would choose for k in range(r):
#
#            for k in range(r - 1):
#            for k in range(r):
#            for k in range(r + 1):
...
#       The underscore is a the name of a variable that is not used.  We ignore the loop variable.
...
#
#       THE SECOND ONE IS WRONG BECAUSE IT UPDATES x BY THE DIAMETER AND BY A MULTIPLE OF k.
#
#              x = starting_point.x
#              for k in range(n):
